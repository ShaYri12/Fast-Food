...
export const createCart = async (req, res) => {
    try {
      const { userId, userEmail, foodId, foodName, quantity, phone, price, category, location } = req.body;
  
      if (!userId || !userEmail || foodId || !foodName || !quantity || !phone || !price || !category|| !location) {
...
export const createOrUpdateCart = async (req, res) => {
  try {
    const { userId, foodId, foodName, quantity, photo, price, category } = req.body;
