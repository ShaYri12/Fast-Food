  ...
  <div className='container'>
    <div className='row justify-content-center'>
      <div className='hero-text col-lg-5 col-md-6 col-12 pt-0 pt-lg-5 mt-2'>
        ...
        <Link to="/menu" className='menu-btn btn btn-primary'>Menu</Link>
      </div>
      <div className='hero-img-box col-lg-7 col-md-6 col-9 d-flex justify-content-end align-items-center position-relative'>
        <img className="hero-obj img-fluid position-absolute  ps-5 ps-lg-0 d-none d-md-block" src={heroObj} alt="Hero-obj" />
        <img className="hero-img img-fluid position-relative pt-3 pt-md-0  position-md-absolute me-lg-5 me-3 mb-3 " src={heroImg} alt="Hero-Img" />
      </div>
    </div>
  </div>
</section>
    ...
    <section>
      <div className='container'>
        <div className='row align-items-center justify-content-center g-4'>
          ...
          <div className='category-box col-md-4 col-sm-6 col-12 d-flex align-items-center justify-content-center' key={category.id}>
            <Link to={{
              pathname: '/menu',
              search: `?category=${category.name}`,
            }} className='category rounded-5 overflow-hidden text-center d-flex align-items-center justify-content-center'>
              <h3 className='category-text position-absolute'>{category.name}</h3>
              <img className='img-fluid rounded-5' src={category.photo} alt="CategoryImg"/>
            </Link>
          </div>
        ))}
        </div>
